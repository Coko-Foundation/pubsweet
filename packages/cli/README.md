...
`pubsweet setupdb` command is now deprecated. To set up the database you can use seeding scripts like the example [here](https://gitlab.coko.foundation/micropublication/micropublication/blob/master/scripts/setupDb.sh).
...
`pubsweet adduser` command is now deprecated. To add users to the database you can use seeding scripts, like in the example from micropublication [here](https://gitlab.coko.foundation/micropublication/micropublication/blob/master/scripts/seedUsers.js).
