import logo from '../assets/pubsweet-logo.svg'
import components from '../assets/pubsweet-components.svg'

<Meta title="Design System|Intro" />

# The open toolkit for building publishing workflows

<img src={logo} style={{maxWidth: "200px", display: "block", margin: "1em auto"}} />
...
<img src={components} style={{maxWidth: "500px", "display": "block", margin: "1em auto"}} />
